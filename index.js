...
exports.plugin = async function (schema, options) {
  ...
  if (settings.model == null) {
    console.error("autoIncrement: model must be set");
  ...
  let pluginInitialized = new Promise(async (resolve) => {
